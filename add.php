 ...
 if(isset($_POST['Submit'])) {
     ...
     if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      if($ukuran < 1044070){			
        ...
        $result = mysqli_query($mysqli, "INSERT INTO postingan(judul,caption,nama_file) VALUES('$judul','$caption','$nama')");
        if($result){
          // Show message when postingan added
          echo "<div class='alert alert-primary' role='alert'>
            Postingan berhasil dibuat!
          </div>";
        }else{
          echo "<div class='alert alert-danger' role='alert'>
            Postingan gagal dibuat!
          </div>";
        }
      }else{
        echo "<div class='alert alert-danger' role='alert'>
 ...
 ?>
    <form action="add.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea2" rows="3" name="caption"></textarea>
        </div>
        <div class="mb-3">
...
<footer class="text-body-secondary py-5">
  <div class="container">
    ...
    <p class="mb-1">IGKW3 is &copy; DTS VSGA, but please do not only copas, make a change!</p>
