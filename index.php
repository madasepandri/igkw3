...
$result = mysqli_query($mysqli, "SELECT * FROM postingan ORDER BY id DESC");
?>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        while($user_data = mysqli_fetch_array($result)) {
          ...
          <div class='card shadow-sm'>
              <img src='foto/".$user_data['nama_file']."' width='300' height='200'>
                <div class='card-body'>
                  <p class='card-text'>".$user_data['caption']."</p>
                <div class='d-flex justify-content-between align-items-center'>
                  <div class='btn-group'>
                    <button type='button' class='btn btn-sm btn-outline-secondary'>View</button>
                    <button type='button' class='btn btn-sm btn-outline-secondary'>Edit</button>
                  </div>
                  <small class='text-body-secondary'>".$user_data['judul']."</small>
                </div>
              </div>
            </div>
          </div>";
